...
syms px py pz 'real' % integrated velocity in body frame
...
stateVector = [quat;vn;ve;vd;pn;pe;pd;dAngBias;dVelBias;pbf;magN;magE;magD;magX;magY;magZ;vwn;vwe];
nStates=numel(stateVector);

% Define vector of process equations
stateVectorNew = [quatNew;vNew;pNew;dAngBiasNew;dVelBiasNew;pbfNew;magNnew;magEnew;magDnew;magXnew;magYnew;magZnew;vwnNew;vweNew];
...
f = matlabFunction(Q,'file','calcQ27.m');

% derive the state transition matrix
F = jacobian(stateVectorNew, stateVector);
f = matlabFunction(F,'file','calcF27.m');
